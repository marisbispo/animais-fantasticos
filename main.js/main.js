...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimacaoScroll)\n/* harmony export */ });\nfunction initAnimacaoScroll() {\n  var sections = document.querySelectorAll('[data-anime=\"scroll\"]');\n  var windowAltura = window.innerHeight * 0.6;\n\n  function animaScroll() {\n    sections.forEach(function (section) {\n      var sectionTop = section.getBoundingClientRect().top;\n      var isSectionVisible = sectionTop - windowAltura < 0;\n\n      if (isSectionVisible) {\n        section.classList.add('ativo');\n      } else if (section.classList.contains('ativo')) {\n        section.classList.remove('ativo');\n      }\n    });\n  }\n\n  animaScroll();\n  window.addEventListener('scroll', animaScroll);\n}\n\n//# sourceURL=webpack://animais-lint/./js/modules/scroll-animacao.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ scrollSuave)\n/* harmony export */ });\nfunction scrollSuave() {\n  var hrefMenu = document.querySelectorAll('[data-menu=\"suave\"]');\n\n  function scrollToSection(event) {\n    event.preventDefault();\n    var href = event.currentTarget.getAttribute('href');\n    var section = document.querySelector(href);\n    section.scrollIntoView({\n      behavior: 'smooth',\n      block: 'start'\n    });\n  }\n\n  hrefMenu.forEach(function (menu) {\n    menu.addEventListener('click', scrollToSection);\n  });\n}\n\n//# sourceURL=webpack://animais-lint/./js/modules/scroll-suave.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initTabNav)\n/* harmony export */ });\nfunction initTabNav() {\n  var animaisTexto = document.querySelectorAll('[data-tab=\"content\"] section');\n  var animaisFoto = document.querySelectorAll('[data-tab=\"menu\"] li');\n\n  function desaparecerTexto(index) {\n    animaisTexto.forEach(function (animal) {\n      animal.classList.remove('ativo');\n    });\n    var direcao = animaisTexto[index].dataset.anime;\n    animaisTexto[index].classList.add('ativo', direcao);\n  }\n\n  if (animaisTexto.length && animaisFoto) {\n    animaisTexto[0].classList.add('ativo');\n    animaisFoto.forEach(function (animal, index) {\n      animal.addEventListener('click', function () {\n        desaparecerTexto(index);\n      });\n    });\n  }\n}\nconsole.log('its never wrong when is about love');\n\n//# sourceURL=webpack://animais-lint/./js/modules/tabnav.js?");
